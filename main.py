...
class GUI(object):
    def __init__(self):
        ...
        # GUI widgets
        self.choose_size_button = Scale(self.root, from_=10, to=20, width=12, orient=HORIZONTAL, length=80)
        ...
        self.c = Canvas(self.root, bg='black', width=164, height=164)
    ...
    def process_image(self):
        ...
        # Keep deleting black sides to remove excess black pixels around the digit
        arr = np.array(img)
        ...
        processed.paste(extracted, (int((processed.height-rows)/2), int((processed.width-cols)/2)))
